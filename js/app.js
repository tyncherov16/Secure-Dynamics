(() => {
    ...
    window.onload = function() {
        const animItems = document.querySelectorAll("[data-scrlanim]");
        if (animItems.length > 0) {
            ...
            function animOnScroll(params) {
                for (let i = 0; i < animItems.length; i++) {
                    ...
                    if (pageYOffset > animItemOffset - animItemPoint && pageYOffset < animItemOffset + animItemHeight) animItem.classList.add("active"); else if (!animItem.classList.contains("no-anim")) animItem.classList.remove("active");
                }
            }
            function offset(el) {
